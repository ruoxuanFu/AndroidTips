...
public class KeyboardUtil {
     ...
     */
    public static boolean getInputOpen(Context context) {
        InputMethodManager imm = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
        return imm.isActive();
    }
     ...
     */
    public static void setOnSoftKeyboardChangeListener(Activity activity,
    ...
    public interface OnSoftKeyBoardChangeListener {
         ...
         */
        void onSoftKeyBoardChange(boolean isShow, int keyboardHeight);
    }
}
